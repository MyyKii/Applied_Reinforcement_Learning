...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{plot-3-1.pdf}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{plot-3-2.pdf}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{plot-3-3.pdf}
\end{figure}
Man sieht, dass für $\gamma = 0.85$ der beste $score =\frac{reward}{iterations}$ entsteht, d.h. in diesem Fall ist das beste Preis-Leistungsverhältnis gegeben.
Dort liegt der kumulierte Reward bereits nahe am Maximum, während der Rechenaufwand mit unter 100 Iterationen noch überschaubar bleibt.
Der Ausreißer $\gamma = 0$ ergibt zwar wegen der fast sofortigen Konvergenz einen guten Score, aber wie in 3.2 gesehen keine gute Policy.
\section*{4)}
...
Beim Reward pro Step zeigt sich dagegen eine klare Präferenz für kleine Werte $\ge 0.07$, mit einem Maximum bei $0.21$ mit durchschnittlichem Reward pro Step von $1.96$.
